...
<?php  echo get_all_category_order_by_id_1();   ?>

  <div class="form-group">
  <label for="image">Select image</label>
  <input type="file" class="form_control" name="image">
  </br><img id="myImg"alt="your image" height="100" border-radius="5px" class="form_control" name="image">
  ...
  <textarea name="content" name="editor1" class="form-control ckeditor"></textarea>
   ...
   <script>
	...
	<a href="edit_category.php?id=<?php echo $category_id;?>"  class="btn btn-danger">Cancel</a>
        </form>
    </div>
</div>
