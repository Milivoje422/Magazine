...
<div class="info_user">
    <ul> 
        <li>
            <div class="user_name"> <center>   <?php echo $_SESSION['username'];?> </center></div>
               <div class="a2">
            <ul>
               ...
               <li><a href="show_admin_listings.php"><span class="show"  role="button" data-toggle="modal" data-target="#" aria-expanded="true" aria-controls="modal">Show my listings</span></a></li>
...
confirm_query($result);
       if($result){
            while($user=mysqli_fetch_assoc($result)){
              ?>   
<div class="container"> 
         <div class="row" style="margin:150px; background:rgba(255,255,255,0.6);  margin:15px;" >
...
<div class="lastname">
    ...
    </br><img id="myImg"alt="your image" height="100" src="<?php echo $user['image']; ?>" border-radius="5px" class="form_control" name="image" value="<?php // echo show_user_image_for_show(); ?>"   >
...
<div id="confirm_deletion" class="modal fade" role="dialog">
    ...
    <div class="modal-body">
        <div class="well">
            ...
            <a href="delete_admin.php" class="yes_button">Yes</a> 
        </div>
    </div>
...
<!--              <div id="add_news_modal_2" class="modal fade" role="dialog" >
    <div class="modal-dialog" style="width: 35%;">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title_2">Couse category</h4>
