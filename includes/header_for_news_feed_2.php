...
<div class="lastname">
    ...
    </br><img id="myImg"alt="your image" src="<?php echo $user['image']; ?>" height="100" border-radius="5px" class="form_control" name="image" value="<?php // echo show_user_image_for_show(); ?>"   >
